...
public class OneTimePasswordServiceImpl implements OneTimePasswordService {
    ...
    @Override
    public String generateOTP(User user) throws OTPGenerateException {
        long T0 = 0;
        long X = 30;
        ...
        try {
            for (int i = 0; i < testTime.length; i++) {
                ...
                return generateTOTP(user.getId().toString(), steps, "8");
            }
        }catch (final Exception e) {
            System.out.println("Error : " + e);
            throw new OTPGenerateException(e.getMessage());
        }
        return null;
    }
